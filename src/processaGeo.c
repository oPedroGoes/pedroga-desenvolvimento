...
/*AbdTree*/ void leitura_geo(FILE **ssvg1, FILE *arqgeo, int *instru, int * formcriadas, int *id, float *xcent, float *ycent) {
...
////////////////////////////////////////////////////////////////////////////////////////*/
        ...
        if (strcmp(tipo, "r ") == 0) {
            ...
            *id=i;
            RECTANGLE r = cria_retangulo(i, x, y, w, h, cb, cp);
            if(contadorforms==1){
/*////////////////////////////////////////////////////////////////////////////////////////
                //COMANDOS ESPECIFICOS DO EDU
...
/*AbdTree*/ processa_geo(const char* pathgeo, const char* dirsaida, const char* nomegeo, int *instru, 
                     int *formcriadas, int *id, float *xcent, float *ycent) {
    ...
    /*AbdTree*/ leitura_geo(&ssvg1, arqgeo, instru, formcriadas, id, xcent, ycent);
